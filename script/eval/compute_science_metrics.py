...
class ScienceEvaluator:
    ...
    def reorganize_predictions(self, model_dir):
        ...
        ########## add by Jin ##########
        # add the model name path in the old_dir
        ...
        ########## add by Jin ##########
        # Remove the entire parent directory of old_dir, including old_dir itself
        # This is to ensure each task is in one folder
